...
import pizzaImage from "@assets/stock_images/b55f52d5-be16-469d-aebd-3122a990a077.png";
...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-primary/10 via-background via-50% to-accent/15">
      ...
      <div className="absolute top-[50%] right-[5%] md:right-[10%] lg:right-[5%] -translate-y-1/2 pointer-events-none animate-fade-in float-animation">
        <img
          src={pizzaImage}
          alt="Pizza"
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-28 md:py-36 w-full">
        <div className="max-w-2xl lg:max-w-3xl">
          ...
          <p
            className="text-xl md:text-2xl lg:text-3xl text-foreground/90 font-medium mb-4 animate-fade-in-up"
          ...
          <p
            className="text-base md:text-lg lg:text-xl text-muted-foreground mb-10 animate-fade-in-up"
