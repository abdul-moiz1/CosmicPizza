...
export default function HeroSection() {
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-gradient-to-br from-primary/10 via-background via-50% to-accent/15">
      ...
      <div className="absolute top-[42%] left-[70%] md:left-[75%] lg:left-[78%] -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-15">
        <img 
          src={pizzaImage} 
          alt="Pizza" 
          className="w-[350px] h-[350px] md:w-[450px] md:h-[450px] lg:w-[550px] lg:h-[550px] object-contain animate-spin-slow"
        />
      </div>
